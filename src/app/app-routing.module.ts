...
const routes: Routes = [
  ...
  { path: 'stock-count/:pageName', loadChildren: './pages/stock-count/stock-count.module#StockCountPageModule' },
  ...
  { path: 'stock-count-list/:pageName', loadChildren: './pages/stock-count-list/stock-count-list.module#StockCountListPageModule' },
